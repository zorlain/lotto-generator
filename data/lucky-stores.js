...
const LUCKY_STORES = [
  ...
  { name: "명당골복권방", query: "경기 수원시 권선구 동수원로242번길 15", region: "경기 수원시", sido: "경기", city: "수원시", count: 10 },
  ...
  { name: "썬마트", query: "충북 청주시 흥덕구 가로수로1351번길 41", region: "충북 청주시", sido: "충북", city: "청주시", count: 5 },
  ...
  { name: "대박마트복권방", query: "충남 아산시 음봉면 음봉로 844", region: "충남 아산시", sido: "충남", city: "아산시", count: 5 },
  { name: "로또복권두정점", query: "충남 천안시 서북구 두정로 251", region: "충남 천안시", sido: "충남", city: "천안시", count: 5 },
  { name: "황실복권방", query: "충남 천안시 동남구 목천읍 충절로 799", region: "충남 천안시", sido: "충남", city: "천안시", count: 5 },
  ...
  { name: "GS25 대전시네마점", query: "대전 서구 용문로 41-88", region: "대전 서구", sido: "대전", city: "서구", count: 5 },

  { name: "조치원복권방", query: "세종 조치원읍 원리 9-20", region: "세종 조치원읍", sido: "세종", city: "조치원읍" },

  { name: "또또복권방", query: "전북 익산시 고봉로32길 3", region: "전북 익산시", sido: "전북", city: "익산시", count: 5 },
  { name: "행운복권방", query: "전북 익산시 무왕로 1268", region: "전북 익산시", sido: "전북", city: "익산시", count: 5 },
  { name: "팡팡복권마트", query: "전북 전주시 덕진구 가리내로 26", region: "전북 전주시", sido: "전북", city: "전주시", count: 5 },
  ...
  { name: "알리바이(광주)", query: "광주 광산구 수등로 253", region: "광주 광산구", sido: "광주", city: "광산구", count: 9 },
  ...
  { name: "CU노서점", query: "경북 경주시 금성로259번길 38", region: "경북 경주시", sido: "경북", city: "경주시", count: 8 },
  { name: "NG24", query: "경북 칠곡군 석적읍 북중리3길 59", region: "경북 칠곡군", sido: "경북", city: "칠곡군", count: 5 },
  { name: "로터리편의마트", query: "경북 포항시 북구 서동로 85", region: "경북 포항시", sido: "경북", city: "포항시", count: 5 },
  { name: "행운의집", query: "경북 안동시 영가로 24", region: "경북 안동시", sido: "경북", city: "안동시", count: 5 },
  { name: "동네복권", query: "경북 울진군 울진중앙로 27", region: "경북 울진군", sido: "경북", city: "울진군" },

  { name: "GS25 양산혜인점", query: "경남 양산시 웅상대로 953", region: "경남 양산시", sido: "경남", city: "양산시", count: 11 },
  { name: "목화휴게소", query: "경남 사천시 용현면 사천대로 912", region: "경남 사천시", sido: "경남", city: "사천시", count: 9 },
  { name: "북마산복권전문점", query: "경남 창원시 마산합포구 북성로 98", region: "경남 창원시", sido: "경남", city: "창원시", count: 6 },
  { name: "구산복권방", query: "경남 김해시 가락로 291", region: "경남 김해시", sido: "경남", city: "김해시", count: 5 },
  ...
  { name: "일등복권편의점", query: "대구 달서구 대명천로 220", region: "대구 달서구", sido: "대구", city: "달서구", count: 12 },
  { name: "세진전자통신", query: "대구 서구 서대구로 156", region: "대구 서구", sido: "대구", city: "서구", count: 9 },
  { name: "복권명당(서부점)", query: "대구 달서구 월배로 452", region: "대구 달서구", sido: "대구", city: "달서구", count: 6 },
  { name: "나눔Lotto 메트로센터점", query: "대구 중구 달구벌대로 지하 2100", region: "대구 중구", sido: "대구", city: "중구", count: 4 },
  { name: "천하명당", query: "대구 북구 읍내동 천하명당 로또", region: "대구 북구", sido: "대구", city: "북구", count: 4 },
  { name: "GS25 대구교대점", query: "대구 남구 중앙대로 216", region: "대구 남구", sido: "대구", city: "남구" },
  ...
  { name: "영화유통(1등복권방)", query: "울산 남구 신정로 19", region: "울산 남구", sido: "울산", city: "남구", count: 7 },
  { name: "아이러브마트복권방", query: "울산 중구 유곡로 19-1", region: "울산 중구", sido: "울산", city: "중구", count: 6 },
